window.ZIGOS_ACTIONS_DATA = {
  "groups": [
    {
      "id": "lojas",
      "label": "Lojas e Estabelecimentos",
      "actions": [
        "Barbearia",
        "Loja de Armamentos",
    ...
    {
      "id": "temporario",
      "label": "Ações de Férias (Temporário)",
      "actions": [
        "Hotel Abandonado",
        "Cemitério",
        "Motoclube",
  ...
  "details": {
    ...
    "Barbearia": {
      ...
      "policia": "Mesma quant. dos bandidos",
      "refens": "Proibido",
    ...
    "Ações de Rua (PvP)": {
      "bandidos": "Sem limite definido",
      "policia": "Sem limite definido",
      "refens": "-",
    ...
    "Corrida Ilegal": {
      "bandidos": "1 Veículo cheio",
      "policia": "Máximo 3 VTRs (+Heli)",
      "refens": "Proibido",
    ...
    "Boosting": {
      "bandidos": "1 VTR Boosting + 1 Suporte (máx 4)",
      "policia": "Máximo 4 VTRs (+Heli)",
      "refens": "-",
      "armamento": "Livre",
    ...
    "Sequestro / Refém / Negociação": {
      "bandidos": "Sempre em maior número",
      "policia": "Negociável",
      "refens": "1 refém a cada 2 bandidos",
      "armamento": "Livre",
